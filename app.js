...
client.on('message', async msg => {
  ...
  if (msg.selectedButtonId === 'reset_service' || msg.body.toLowerCase().includes('voltar') || msg.body.toLowerCase().includes('menu') || contactUser.service === 'reset_service') {
    await ContactController.update({
      phone_number: contactNumber,
      actual_level: 0,
      service: 'no_service',
  ...
  if (msg.selectedRowId === 'cnega_service' || +msg.body === 3 || contactUser.service === 'cnega_service') {
    cnegaService(contactUser, msg, contactNumber, nomeAtendente, client, chat)
  }

  else if (msg.selectedRowId === 'iptu_service' || +msg.body === 1 || contactUser.service === 'iptu_service') {
  ...
  // - Lista de atendimentos 
    ...
    AttService(contactUser, msg, client)
  }
